...
export default function CourseDetails() {
  ...
  const tabs = ['Resources', 'Assignments', 'Test & Quizzes', 'Grade Book', 'Courses Group', 'Calendar'];
  const { id } = useParams();
  ...
  const lessons = [
    {
      ...
      materials: [
        { 
          ...
          duration: '45 min',
          views: 128,
          description: 'This video covers the fundamental principles of accounting recording, including journal entries, ledgers, and the accounting cycle.'
        },
        { 
          id: 2, 
          type: 'slides', 
          ...
          pages: 24,
          downloads: 87,
          description: 'Lecture slides covering the basic concepts of accounting, financial statements, and accounting equations.'
        },
        { 
          id: 3, 
          type: 'document', 
          ...
          pages: 56,
          downloads: 42,
          description: 'Comprehensive resource document detailing various accounting theories and their practical applications.'
        }
      ]
    },
    { 
      ...
      materials: [
        { 
          ...
          duration: '52 min',
          views: 94,
          description: 'Detailed analysis of balance sheets, income statements, and cash flow statements with practical examples.'
        }
      ] 
    },
    { 
  ...
  const assignments = [
    {
      ...
      points: '100 points',
      submitted: false,
      description: 'Analyze the provided financial statements and prepare a report on the company\'s financial health.',
      instructions: 'Use the concepts learned in Lesson 2. Minimum 5 pages, APA format. Submit as PDF.'
    },
    {
      id: 2,
      ...
      submitted: true,
      grade: '45/50',
      feedback: 'Excellent work! Just a few minor errors in the compound journal entries.',
      description: 'Practice journal entries for various business transactions.',
  ...
  const grades = [
    ...
    },
    {
      ...
      weight: '20%',
      items: [
        { name: 'Basic Accounting Principles Quiz', score: '47/50', percentage: '94%' }
      ],
      totalScore: '47/50',
      totalPercentage: '94%'
    },
  ...
  const groups = [
    {
      ...
      members: 4,
      projects: [
        { name: 'Corporate Financial Analysis', deadline: 'Jun 25, 2024', progress: 65 }
      ],
      description: 'Group focused on analyzing financial statements of Fortune 500 companies'
    },
    {
      id: 2,
      ...
      description: 'Group examining contemporary auditing practices and standards'
    }
  ];
  ...
  const getStatusIcon = (status: string) => {
    switch(status) {
      case 'Due': return <AlertCircle size={16} className="text-red-500" />;
      case 'Submitted': return <CheckCircle size={16} className="text-green-500" />;
      case 'Upcoming': return <Clock size={16} className="text-blue-500" />;
    ...
    switch(activeTab) {
        ...
        return (
          <div className="flex flex-col h-full">
            ...
            <div className="flex border-b">
              <button style={{backgroundColor: themeColors.primary.main}} className="flex items-center px-4 py-3 text-white">
                        ...
                        {lesson.materials.map(material => (
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <p className="text-xs text-gray-500 truncate">{material.lecturer}</p>
                            </div>
                ...
                {previewMaterial ? (
                  <div className="bg-white rounded-lg shadow-sm border p-4">
                    <div className="flex justify-between items-start mb-4">
                      <div>
                        <h3 className="text-xl font-bold text-gray-800">{previewMaterial.title}</h3>
                        <p className="text-sm text-gray-600">Posted by {previewMaterial.lecturer} on {previewMaterial.date}</p>
                      </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-6">
                      <div>
                        ...
                        <p className="text-gray-600 capitalize">{previewMaterial.type}</p>
                      </div>
                      {previewMaterial.duration && (
                        <div>
                          <h4 className="font-medium text-gray-700 mb-1">Duration</h4>
                          <p className="text-gray-600">{previewMaterial.duration}</p>
                        </div>
                      )}
                      {previewMaterial.pages && (
                        <div>
                          <h4 className="font-medium text-gray-700 mb-1">Pages</h4>
                          <p className="text-gray-600">{previewMaterial.pages}</p>
                        </div>
                      )}
                      {previewMaterial.views && (
                        <div>
                          <h4 className="font-medium text-gray-700 mb-1">Views</h4>
                          <p className="text-gray-600">{previewMaterial.views}</p>
                        </div>
                      )}
                    </div>
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-gray-500">
                    ...
                    <p className="text-sm">Click on any lesson material to view details here</p>
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-4">
                ...
                {assignments.map(assignment => (
                  <div key={assignment.id} className="border rounded-lg mb-4 hover:shadow-md transition-shadow">
                      ...
                      <div className="flex justify-between items-start">
                        ...
                        <div className="text-right">
                          <span className={`inline-block px-2 py-1 text-xs rounded ${
                            assignment.status === 'Due' ? 'bg-red-100 text-red-800' :
                    ...
                    <div className="p-4 bg-gray-50">
                      ...
                      <div className="mt-4 flex justify-end space-x-2">
                        {assignment.status === 'Due' && (
                          <button className="bg-green-600 text-white px-4 py-2 rounded text-sm hover:bg-green-700 flex items-center">
                            <FilePlus size={16} className="mr-2" />
                            Submit Assignment
                          </button>
                        )}
      ...
      case 'Test & Quizzes':
        return (
          <div className="flex flex-col h-full">
            {/* Quiz Tabs */}
            <div className="flex border-b">
              <button style={{background: themeColors.primary.main}} className="flex items-center px-4 py-3 text-white">
            ...
            <div className="flex-1 overflow-y-auto p-4">
              <div className="mb-6">
                <h3 className="text-lg font-bold text-gray-800 mb-2">Tests & Quizzes</h3>
                <p className="text-sm text-gray-600">View all upcoming and completed assessments</p>
              </div>
              
              {quizzes.map(quiz => (
                <div key={quiz.id} className="border rounded-lg mb-4 hover:shadow-md transition-shadow">
                  <div className="p-4 border-b">
                    <div className="flex justify-between items-start">
                      <div className="flex items-start">
      ...
      case 'Grade Book':
        return (
          <div className="flex flex-col h-full">
            {/* Grade Book Header */}
            <div style={{backgroundColor: themeColors.primary.main}} className="text-white p-4">
              <div className="flex justify-between items-center">
                <div>
                  <h2 className="text-xl font-bold">ACT 301 - Grade Summary</h2>
                  <p className="text-sm text-blue-100">Current Overall: 92.5% (A)</p>
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-4">
                ...
                <div key={index} className="mb-6">
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="text-sm text-gray-600">
                      Weight: <span className="font-medium">{category.weight}</span>
                    </div>
                  </div>
                    ...
                    {category.items.length > 0 ? (
                      <>
                        {category.items.map((item, itemIndex) => (
                          <div key={itemIndex} className="px-4 py-3 grid grid-cols-12 border-t text-sm hover:bg-gray-50">
                            <div className="col-span-6 text-gray-800">{item.name}</div>
                            <div className="col-span-3 text-right font-medium">{item.score}</div>
                            <div className="col-span-3 text-right text-green-600">{item.percentage}</div>
                          </div>
                        ))}
                        <div className="bg-gray-50 px-4 py-2 grid grid-cols-12 border-t text-sm font-medium">
                          ...
                          <div className="col-span-3 text-right">{category.totalScore}</div>
                          <div className="col-span-3 text-right text-blue-600">{category.totalPercentage}</div>
                        </div>
                      </>
                    ) : (
              ...
              <div className="bg-white border rounded-lg p-4 mt-6">
                <h3 className="font-bold text-gray-800 mb-3">Overall Performance</h3>
                  ...
                  <div key={group.id} className="border rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                    <div className="bg-indigo-100 px-4 py-3 flex justify-between items-center">
                      <div className="flex items-center">
                        ...
                        <h3 className="font-bold text-indigo-800">{group.name}</h3>
                      </div>
                    ...
                    <div className="p-4">
                      ...
                      <div className="mb-4">
                        <h4 className="font-medium text-gray-700 mb-2">Active Projects</h4>
                        {group.projects.map((project, pIndex) => (
                          <div key={pIndex} className="bg-gray-50 p-3 rounded border mb-2 last:mb-0">
                    ...
                    <div className="flex">
                      ...
                      <div className="flex-1 p-3">
                        <div className="flex justify-between items-start">
                          <div className="flex items-center">
                            {getIcon(event.type)}
                            <h4 className="font-bold text-gray-800 ml-2">{event.title}</h4>
                          </div>
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <div className="bg-white p-4 border-b">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-2xl font-bold text-gray-800">ACT 301 - Advanced Accounting</h1>
      ...
      {/* Content Area */}
      <div className="flex-1 w-[80dvw] pb-24">
        {renderTabContent()}
      </div>
    </div>
  );
